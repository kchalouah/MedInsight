    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-slate-50 relative overflow-hidden font-body">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
                ...
                <div className="absolute top-[20%] right-[10%] w-[30%] h-[30%] rounded-full bg-indigo-500/5 blur-3xl" />
            </div>
                ...
                <Card className="border-slate-200 shadow-xl bg-white/90 backdrop-blur-sm">
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <form onSubmit={handleEmailLogin} className="space-y-4">
                            {error && (
                                <div className="p-3 text-sm text-red-600 bg-red-50 rounded-md border border-red-100 flex items-center">
                    ...
                    <CardFooter className="flex flex-col space-y-4 pt-2">
                        <div className="w-full pt-4 border-t border-slate-100">
                            <p className="text-center text-sm text-slate-600 mb-3">Nouveau sur MedInsight ?</p>
                            <div className="grid grid-cols-2 gap-3">
                                <Link href="/register/patient" className="w-full">
                                    <Button variant="secondary" className="w-full text-xs h-9 bg-slate-100 hover:bg-slate-200 text-slate-900 border border-slate-200">
                                        Compte Patient
                                    </Button>
                                </Link>
                                <Link href="/register/medecin" className="w-full">
                                    <Button variant="secondary" className="w-full text-xs h-9 bg-slate-100 hover:bg-slate-200 text-slate-900 border border-slate-200">
                                        Compte Médecin
                                    </Button>
                                </Link>
