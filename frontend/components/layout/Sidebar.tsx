...
const navigationConfig = {
    ...
    medecin: [
        ...
        { name: "Planning du Jour", href: "/medecin/planning", icon: Calendar },
        { name: "Mes Patients", href: "/medecin/patients", icon: Users },
        { name: "Consultation", href: "/medecin/consultation", icon: Stethoscope },
        { name: "Statistiques", href: "/medecin/statistics", icon: BarChart3 },
    ],
    admin: [
    ...
    security: [
        ...
        { name: "Logs d'Audit", href: "/security/audit-logs", icon: ClipboardList },
